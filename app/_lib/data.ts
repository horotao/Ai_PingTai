export type ModelKey = 'gpt-image-2' | 'gpt-image-2-official';
...
export const SAMPLE_HISTORY: any[] = [
  ...
  { id: 'h-005', prompt: '中式山水 × 霓虹招牌，水墨渐变，东方赛博', model: 'gpt-image-2-official', ratio: '21:9', resolution: '2k', n: 4, status: 'completed', createdAt: Date.now() - 1000 * 60 * 60 * 96 },
];
...
export function clsx(...xs: any[]): string {
  return xs.filter(Boolean).join(' ');
}

export function hueFor(seed: any, salt: number | string = 0): number {
  let s = 0;
